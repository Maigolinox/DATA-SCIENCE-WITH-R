...
* Tener `R` y RStudio instalados
* Hbaer leido el prework

## DESARROLLO

Un estimador insesgado es aquel cuya esperanza matemática coincide con el valor del parámetro que sea desea estimar. En caso de no coincidir se dice que el estimador tiene sesgo.
...
# RETO 2 SESION 4. ALGUNOS ESTIMADORES PUNTUALES INSESGADOS COMUNES

## OBJETIVO

* Entender la idea del estimador puntual insesgado
...
4. Encuentre la media muestral y desviación estandar muestral de las 1500 medias
...
Llevar a cabo contrastes de hipotesis que ayuden a tomar decisiones 

## DESARROLLO

Un contraste de hipótesis es un procedimiento para juzgar si una propiedad que se supone en una población estadística es compatible con lo observado en una muestra de dicha población. Fue iniciada por Ronald Fisher y fundamentada posteriormente por Jerzy Neyman y Karl Pearson.
...
# RETO 3. CONTRASTE DE HIPOTESIS

## OBJETIVO

* Llevar a cabo un contraste de hiptoesis acerca de la media de una población normal cuando el tamaño muestral es pequeño
