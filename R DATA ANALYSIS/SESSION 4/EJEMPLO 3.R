...
print("ENSAYO BERNOULLI Con las siguientes instrucciones obtenemos un solo valor, en donde el 0 (fracaso) puede ocurrir con probabilidad 0.45 y el 1 (éxito) con probabilidad p = 0.55")
set.seed(345)
...
print("Obtenemos 1150 muestras aleatorias de tamaño n1 = 54 de una distribución exponencial con parámetro lambda1 = 3.2 y otras 1150 muestras aleatorias de tamaño n2 = 41 de una distribución exponencial con parámetro lambda2 = 1.5.")
...
print("Obtenemos 1100 muestras de tamaño n1 = 48 de una v.a. Bernoulli con p1 = 0.65 y otras 1100 muestras de tamaño n2 = 35 de una v.a. Bernoulli con p2 = 0.53")
