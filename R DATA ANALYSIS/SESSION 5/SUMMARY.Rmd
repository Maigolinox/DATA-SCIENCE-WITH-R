...
# tiempo asignelo a una variable llamada `listasoccer`. Se creará
...
# usando unicamente datos desde la fecha inicial y hasta la penúltima
...
# la estrucura de nuestros nuevos data frames
