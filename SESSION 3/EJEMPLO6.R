#EJEMPLO6.SERIES DE TIEMPO Y DESCOMPOSICIÓN


##UTILIZAREMOS UN DATASET DEL PAQUETE DATASETS
library(datasets)
...
legend(1949, 800, 
       c('Serie de tiempo original', 'Tendencia',
         'Tendencia x Estacionalidad'),
       col = c('black', 'purple', 'red'),
       text.col = "green4", lty = c(1, 1, 2),
       lwd = c(1, 2, 2),
       merge = TRUE,
       bg = 'gray90')
