...
#Lo primero que haremos es cargar los paquetes que usaremos más adelante. Usamos las 
#funciones suppressWarnings y supperssMessages para que no se impriman mensajes ni 
...
#Ahora seleccionaremos únicamente las columnas Date, HomeTeam, AwayTeam,
...
#Con la función apply primero dividimos cada elemento de las columnas de la 
#matriz de probabilidades conjuntas, por las probabilidades marginales asociadas 
#y que corresponden al equipo de casa. Note como hemos definido una función anómima
# dentro de apply. Luego dividimos cada elemento de las filas de la matriz que resulta,
# por las probabilidades marginales asociadas y que corresponden al equivo visitante. 
#Finalmente hacemos obtenemos la transpuesta de la matriz que resulta. Esta última matriz,
# es la matriz de cocientes buscada, es decir, hemos dividio cada probabilidad conjunta,
...
# y obtenga una idea de las distribuciones de los cocientes. 
