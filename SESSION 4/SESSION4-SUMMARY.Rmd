...
La funcion de densidad de probabilidad de una variable aleatoria $x$ que se distribuye como normal con media $\mu$ y desviacion estandar $\sigma$ es: $f(x)=\dfrac{1}{\sigma\cdot\sqrt{2\pi}}\cdot e^{-{\dfrac{(x-\mu)^2}{(2\sigma)^2}}} $ 
